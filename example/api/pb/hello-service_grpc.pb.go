...
const (
	HelloService_SayHello_FullMethodName       = "/example.api.HelloService/SayHello"
	HelloService_SayHelloStream_FullMethodName = "/example.api.HelloService/SayHelloStream"
)
...
func (x *helloServiceSayHelloStreamClient) Send(m *HelloRequest) error {
...
func (UnimplementedHelloServiceServer) SayHelloStream(HelloService_SayHelloStreamServer) error {
...
func (x *helloServiceSayHelloStreamServer) Recv() (*HelloRequest, error) {
	m := new(HelloRequest)
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "example.api.HelloService",
